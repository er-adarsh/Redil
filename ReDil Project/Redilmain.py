...
# Chatbot responses
greetings = ["Hello!", "Hi there!", "Namaste!", "Hey!", "Hi!"]
positive_responses = [
    "I'm glad you're happy!", "That's wonderful to hear!", "Awesome!", "Great to hear that!",
    "Fantastic!", "I'm happy for you!", "That's amazing!", "Keep smiling!", "Wonderful!",
    "That's excellent!", "I'm thrilled for you!", "That's great news!", "So happy for you!",
    "That's fantastic!", "I'm delighted to hear that!", "That's awesome!", "I'm so pleased for you!",
    "That's brilliant!", "I'm overjoyed for you!", "That's superb!"
]
negative_responses = [
    "I'm sorry to hear that.", "That's tough.", "I understand.", "I'm here for you.",
    "That sounds difficult.", "I'm really sorry.", "I sympathize with you.", "That's unfortunate.",
    "I'm sorry you're going through this.", "I wish I could help more."
]
jokes = [
